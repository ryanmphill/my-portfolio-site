@frontmatter
{
    ...
    "og_image": "https://ryanphillips.dev/static/assets/images/blog/2025/hello-world-preview-1200x630.png",
...
The biggest projects taking up my free time right now are [this website](/) and my [static site generator (Shodo)](https://shodo.dev) that I am using to build it. It really has become a much larger project than I ever anticipated! If I were more sensible I would have just used something like [Hugo](https://gohugo.io/), [11ty](https://www.11ty.dev/), or [Astro](https://astro.build/), but building my own has been so much more fun! 

I knew next to nothing about static site generators before I started, so there have definitely been some growing pains and things I would do differently if starting from scratch. Nevertheless, I am happy with the little set of scripts I've been able to put together, and it's all [open source](https://pypi.org/project/shodo-ssg/) if ever anyone else wants to try it out. It is still pre-release technically, but I'm now very close to pushing out the first stable version, and I don't have any plans on introducing breaking changes in the near future. As of now, it can currently do everything I want it to on the markdown side of things. Now I just need to catch up on adding some of the same features for JSON content and write a few more CLI functions, but I should make a separate blog post for that!

## Stay tuned!

If you've made it this far down, thanks for reading the debut to this blog! I'm making this as a fun little side project for me to speak into the void about software-related things, but hopefully I will also write some useful and valuable posts in the near future. If you're interested in seeing future posts and are savvy with RSS readers, consider yourself formally invited to [subscribe to my feed](/feed.xml).